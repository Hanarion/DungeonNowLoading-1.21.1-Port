...
public class MobConfig {
    ...
    //public static ModConfigSpec.DoubleValue POPULATE_WITH_STRONG_MOBS;
    public static ModConfigSpec.DoubleValue DUNGEON_MOB_HEALTH_MODIFIER;
    public static ModConfigSpec.DoubleValue DUNGEON_MOB_ATTACK_MODIFIER;
