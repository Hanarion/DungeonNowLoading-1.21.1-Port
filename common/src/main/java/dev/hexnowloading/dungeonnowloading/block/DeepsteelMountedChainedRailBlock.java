...
public class DeepsteelMountedChainedRailBlock extends ChainedRailBlock {
    public DeepsteelMountedChainedRailBlock(Properties properties) {
        super(properties);
    }
    ...
    public void neighborChanged(BlockState state, Level level, BlockPos pos, Block block, BlockPos neighborPos, boolean isMoving) {
        if (!level.isClientSide && level.getBlockState(pos).is(this)) {
            this.schedulePowerUpdate(level, pos);
        }
    }
