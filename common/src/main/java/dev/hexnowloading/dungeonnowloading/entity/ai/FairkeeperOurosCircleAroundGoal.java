...
public class FairkeeperOurosCircleAroundGoal extends Goal {
    ...
    public FairkeeperOurosCircleAroundGoal(FairkeeperOurosEntity.FairkeeperOurosState state, FairkeeperOurosEntity ouros, double radius, double speed, boolean clockwise) {
        this.state = state;
        this.ouros = ouros;
        this.radius = radius;
        this.speed = speed;
    ...
    public boolean canUse() {
        ...
        return this.circlingTarget != null && this.circlingTarget.isAlive() && this.ouros.isState(state);
    }
