...
public class BrokenGarholdModel<T extends BrokenGarholdEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(DungeonNowLoading.MOD_ID, "broken_garhold"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        Garhold.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }
