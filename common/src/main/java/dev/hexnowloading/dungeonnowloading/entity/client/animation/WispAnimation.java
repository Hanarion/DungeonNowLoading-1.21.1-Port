...
public class WispAnimation {
    ...
    public static final AnimationDefinition FLARE_UP = AnimationDefinition.Builder.withLength(1.5F)
            .addAnimation("wisp", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(1.3333F, KeyframeAnimations.degreeVec(8.3797F, -0.6F, 5.4365F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition TACKLE_START = AnimationDefinition.Builder.withLength(0.75F)
            .addAnimation("wisp", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            .addAnimation("wisp", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 0.04F, -0.08F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("wisp", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.5F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM)
    ...
    public static final AnimationDefinition TACKLE = AnimationDefinition.Builder.withLength(1.9167F).looping()
            ...
            .addAnimation("wisp", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.04F, -0.08F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.3333F, KeyframeAnimations.posVec(0.0F, -1.03F, -0.07F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, 0.04F, -0.08F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, -1.03F, -0.07F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.3333F, KeyframeAnimations.posVec(0.0F, -0.1F, -0.06F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.6667F, KeyframeAnimations.posVec(0.0F, -1.03F, -0.07F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.9167F, KeyframeAnimations.posVec(0.0F, 0.04F, -0.08F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("wisp", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    new Keyframe(0.1667F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.15F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("outerlayer", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(8.3797F, -0.6F, 5.4365F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.0833F, KeyframeAnimations.degreeVec(8.28F, 0.1634F, 0.199F), AnimationChannel.Interpolations.CATMULLROM),
