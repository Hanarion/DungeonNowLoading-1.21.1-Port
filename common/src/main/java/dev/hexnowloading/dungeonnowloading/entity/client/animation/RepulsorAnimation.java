...
public class RepulsorAnimation {
    ...
    public static final AnimationDefinition RECHARGE = AnimationDefinition.Builder.withLength(0.5F)
            .addAnimation("base", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.0833F, KeyframeAnimations.posVec(0.0F, -0.6F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.2083F, KeyframeAnimations.posVec(0.0F, 0.25F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.3333F, KeyframeAnimations.posVec(0.0F, -0.19F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("antenna", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.375F, KeyframeAnimations.posVec(0.0F, -0.19F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("Shockwave2", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    ...
                    new Keyframe(0.25F, KeyframeAnimations.scaleVec(1.3F, 1.3F, 1.3F), AnimationChannel.Interpolations.CATMULLROM),
