...
public class FairkeeperBorosAnimation {
    public static final AnimationDefinition PURSUE_OPEN_MOUTH = AnimationDefinition.Builder.withLength(0.9167F)
			...
			.addAnimation("glottis", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("glottis", new AnimationChannel(AnimationChannel.Targets.SCALE,
					new Keyframe(0.2083F, KeyframeAnimations.scaleVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.25F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.LINEAR)
			))
...
public static final AnimationDefinition PURSUE_OPENED_MOUTH = AnimationDefinition.Builder.withLength(0.1667F).looping()
		.addAnimation("upper_jaw", new AnimationChannel(AnimationChannel.Targets.ROTATION,
...
public static final AnimationDefinition PURSUE_CLOSE_MOUTH = AnimationDefinition.Builder.withLength(0.7083F)
		.addAnimation("upper_jaw", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-40.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
