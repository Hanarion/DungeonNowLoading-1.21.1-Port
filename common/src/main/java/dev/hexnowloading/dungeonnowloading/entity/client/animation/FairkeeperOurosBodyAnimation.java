...
public class FairkeeperOurosBodyAnimation {
    public static final AnimationDefinition SCUTTLE_OPEN = AnimationDefinition.Builder.withLength(3.0F)
            ...
            .build();
    public static final AnimationDefinition SCUTTLE_CLOSE = AnimationDefinition.Builder.withLength(1.625F)
            .addAnimation("barrel", new AnimationChannel(AnimationChannel.Targets.SCALE,
			new Keyframe(0.0F, KeyframeAnimations.scaleVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("trap_door_front", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition CANNON_OPEN = AnimationDefinition.Builder.withLength(2.0F)
            .addAnimation("trap_door_front", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0417F, KeyframeAnimations.degreeVec(5.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0833F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition CANNON_CLOSE = AnimationDefinition.Builder.withLength(2.0F)
            .addAnimation("trap_door_front", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(90.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(0.625F, KeyframeAnimations.degreeVec(120.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(0.75F, KeyframeAnimations.degreeVec(-2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            new Keyframe(0.5417F, KeyframeAnimations.posVec(0.0F, 16.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition CANNON_IDLE = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("cannon", new AnimationChannel(AnimationChannel.Targets.POSITION,
