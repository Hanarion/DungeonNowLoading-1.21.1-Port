...
public class DNLItems {
    ...
    public static final Supplier<Item> REDSTONE_CATALYST = register("redstone_catalyst", () -> new CopperDetonatorItem(new Item.Properties().rarity(Rarity.EPIC).durability(10)));
