...
public class DNLItems {
    ...
    public static final Supplier<Item> OVERLOADED_REDSTONE_BLOCK = register("overloaded_redstone_block", () -> new BlockItem(DNLBlocks.OVERLOADED_REDSTONE_BLOCK.get(), new Item.Properties()));
