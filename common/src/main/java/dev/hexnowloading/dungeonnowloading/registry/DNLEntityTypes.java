...
public class DNLEntityTypes {
    ...
    public static final Supplier<EntityType<LargeWispProjectileEntity>> LARGE_WISP_PROJECTILE = register("large_wisp_projectile", () -> EntityType.Builder.<LargeWispProjectileEntity>of(LargeWispProjectileEntity::new, MobCategory.MISC).sized(1.5F, 1.5F).clientTrackingRange(4).updateInterval(20).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "large_wisp_projectile").toString()));
