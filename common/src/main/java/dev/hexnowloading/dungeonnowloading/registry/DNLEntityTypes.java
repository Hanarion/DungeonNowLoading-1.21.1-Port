...
public class DNLEntityTypes {
    ...
    public static final Supplier<EntityType<WispLanternEntity>> WISP_LANTERN = register("wisp_lantern", () -> EntityType.Builder.of(WispLanternEntity::new, MobCategory.MONSTER).sized(1.125F, 1.125F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "wisp_lantern").toString()));
