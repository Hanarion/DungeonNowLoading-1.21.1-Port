...
public class DNLEntityTypes {
    ...
    public static final Supplier<EntityType<BallistaGolemEntity>> BALLISTA_GOLEM = register("ballista_golem", () -> EntityType.Builder.of(BallistaGolemEntity::new, MobCategory.MONSTER).sized(2.97F, 4.0F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "ballista_golem").toString()));
    ...
    public static final Supplier<EntityType<VertexOrbProjectileEntity>> VERTEX_ORB_PROJECTILE = register("vertex_orb_projectile", () -> EntityType.Builder.<VertexOrbProjectileEntity>of(VertexOrbProjectileEntity::new, MobCategory.MISC).sized(0.75F, 0.75F).clientTrackingRange(4).build(new ResourceLocation(DungeonNowLoading.MOD_ID, "vertex_orb_projectile").toString()));
    public static final Supplier<EntityType<VertexDomainProjectileEntity>> VERTEX_DOMAIN_PROJECTILE = register("vertex_domain_projectile", () -> EntityType.Builder.of(VertexDomainProjectileEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).clientTrackingRange(4).build(new ResourceLocation(DungeonNowLoading.MOD_ID, "vertex_domain_projectile").toString()));
    public static final Supplier<EntityType<BorusArrowEntity>> BORUS_ARROW = register("borus_arrow", () -> EntityType.Builder.of(BorusArrowEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(DungeonNowLoading.MOD_ID, "borus_arrow").toString()));
