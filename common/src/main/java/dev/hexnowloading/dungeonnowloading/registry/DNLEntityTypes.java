...
public class DNLEntityTypes {
    ...
    public static final Supplier<EntityType<FairkeeperBorosEntity>> FAIRKEEPER_BOROS = register("fairkeeper_boros", () -> EntityType.Builder.<FairkeeperBorosEntity>of(FairkeeperBorosEntity::new, MobCategory.MONSTER).sized(4.0F, 4.0F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "fairkeeper").toString()));
    public static final Supplier<EntityType<FairkeeperBorosPartEntity>> FAIRKEEPER_BOROS_PART = register("fairkeeper_boros_part", () -> EntityType.Builder.<FairkeeperBorosPartEntity>of(FairkeeperBorosPartEntity::new, MobCategory.MONSTER).sized(4.0F, 4.0F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "fairkeeper_borus_part").toString()));
    public static final Supplier<EntityType<FairkeeperOurosEntity>> FAIRKEEPER_OUROS = register("fairkeeper_ouros", () -> EntityType.Builder.<FairkeeperOurosEntity>of(FairkeeperOurosEntity::new, MobCategory.MONSTER).sized(4.0F, 4.0F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "fairkeeper_ouros").toString()));
    public static final Supplier<EntityType<FairkeeperOurosPartEntity>> FAIRKEEPER_OUROS_PART = register("fairkeeper_ouros_part", () -> EntityType.Builder.<FairkeeperOurosPartEntity>of(FairkeeperOurosPartEntity::new, MobCategory.MONSTER).sized(4.0F, 4.0F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "fairkeeper_ouros_part").toString()));
    public static final Supplier<EntityType<FairkeeperSerpentCallerEntity>> FAIRKEEPER_SERPENT_CALLER = register("fairkeeper_serpent_caller", () -> EntityType.Builder.of(FairkeeperSerpentCallerEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "fairkeeper_serpent_caller").toString()));
    ...
    public static final Supplier<EntityType<WispEntity>> WISP = register("wisp", () -> EntityType.Builder.of(WispEntity::new, MobCategory.MONSTER).sized(0.75F, 0.75F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "wisp").toString()));
    public static final Supplier<EntityType<LargeWispEntity>> LARGE_WISP = register("large_wisp", () -> EntityType.Builder.of(LargeWispEntity::new, MobCategory.MONSTER).sized(1.35F, 1.35F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "large_wisp").toString()));
    public static final Supplier<EntityType<WispLanternEntity>> WISP_LANTERN = register("wisp_lantern", () -> EntityType.Builder.of(WispLanternEntity::new, MobCategory.MONSTER).sized(0.97F, 0.97F).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "wisp_lantern").toString()));
    ...
    public static final Supplier<EntityType<WispProjectileEntity>> WISP_PROJECTILE = register("wisp_projectile", () -> EntityType.Builder.<WispProjectileEntity>of(WispProjectileEntity::new, MobCategory.MISC).sized(0.75F, 0.75F).clientTrackingRange(4).updateInterval(20).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "wisp_projectile").toString()));
    public static final Supplier<EntityType<LargeWispProjectileEntity>> LARGE_WISP_PROJECTILE = register("large_wisp_projectile", () -> EntityType.Builder.<LargeWispProjectileEntity>of(LargeWispProjectileEntity::new, MobCategory.MISC).sized(1.35F, 1.35F).clientTrackingRange(4).updateInterval(20).fireImmune().build(new ResourceLocation(DungeonNowLoading.MOD_ID, "large_wisp_projectile").toString()));
