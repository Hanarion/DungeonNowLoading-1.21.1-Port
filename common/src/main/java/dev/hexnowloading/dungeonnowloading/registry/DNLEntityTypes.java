...
public class DNLEntityTypes {
    ...
    public static final Supplier<EntityType<WispProjectileEntity>> WISP_PROJECTILE = register("wisp_projectile", () -> EntityType.Builder.<WispProjectileEntity>of(WispProjectileEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(8).updateInterval(10).build(new ResourceLocation(DungeonNowLoading.MOD_ID, "wisp_projectile").toString()));
    public static final Supplier<EntityType<WispProjectileEntity>> WISP_SEEKING_PROJECTILE = register("wisp_seeking_projectile", () -> EntityType.Builder.<WispProjectileEntity>of(WispProjectileEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(8).updateInterval(10).build(new ResourceLocation(DungeonNowLoading.MOD_ID, "wisp_seeking_projectile").toString()));
    ...
    public static final Supplier<EntityType<PayloadEntity>> PAYLOAD = register("payload", () -> EntityType.Builder.<PayloadEntity>of(PayloadEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10).build(new ResourceLocation(DungeonNowLoading.MOD_ID, "payload").toString()));
