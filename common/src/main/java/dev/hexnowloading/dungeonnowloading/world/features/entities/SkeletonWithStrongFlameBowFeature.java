...
public class SkeletonWithStrongFlameBowFeature extends Feature<NoneFeatureConfiguration> {

    public SkeletonWithStrongFlameBowFeature() { super(NoneFeatureConfiguration.CODEC); }
