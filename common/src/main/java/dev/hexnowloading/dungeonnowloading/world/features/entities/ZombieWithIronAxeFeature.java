...
public class ZombieWithIronAxeFeature extends Feature<NoneFeatureConfiguration> {
    ...
    private static ItemStack ironAxe(net.minecraft.core.HolderLookup.Provider registries) {
        ItemStack itemStack = new ItemStack(Items.IRON_AXE);
        itemStack.enchant(DNLEnchantments.holder(registries, Enchantments.SHARPNESS), 3);
        itemStack.enchant(DNLEnchantments.holder(registries, Enchantments.KNOCKBACK), 2);
        return itemStack;
    }
