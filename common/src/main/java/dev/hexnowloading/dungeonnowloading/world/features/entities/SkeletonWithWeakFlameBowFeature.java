...
public class SkeletonWithWeakFlameBowFeature extends Feature<NoneFeatureConfiguration> {

    public SkeletonWithWeakFlameBowFeature() { super(NoneFeatureConfiguration.CODEC); }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        skeleton.lootTable = ResourceLocation.fromNamespaceAndPath(DungeonNowLoading.MOD_ID, "entities/modified/iron_skeleton");
    ...
    private static ItemStack weakFlameBow(net.minecraft.core.HolderLookup.Provider registries) {
        ...
        itemStack.enchant(DNLEnchantments.holder(registries, Enchantments.POWER_ARROWS), 3);
        itemStack.enchant(DNLEnchantments.holder(registries, Enchantments.FLAMING_ARROWS), 1);
        return itemStack;
    }
