 ...
 * @author Author
 */
public class command_pylonAnimation {
	public static final AnimationDefinition animation.setup = AnimationDefinition.Builder.withLength(3.75F)
	...
	public static final AnimationDefinition animation.idle = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("base", new AnimationChannel(AnimationChannel.Targets.POSITION, 
	...
	public static final AnimationDefinition animation.base_down = AnimationDefinition.Builder.withLength(3.0F)
		.addAnimation("base", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition animation.base_up = AnimationDefinition.Builder.withLength(3.0F)
		.addAnimation("base", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.0833F, KeyframeAnimations.posVec(0.0F, 0.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.1667F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
